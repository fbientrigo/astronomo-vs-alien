...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\fbien.DESKTOP-6FMEAR7\Documents\GitHub Branch 2\astronomovs\astrovs'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\fbien.DESKTOP-6FMEAR7\Documents\GitHub Branch 2\astronomovs\astrovs\Scripts\deactivate.nu'
